object DataModuleVente: TDataModuleVente
  ...
  object FDMemTableListProduit: TFDMemTable
    ...
    Top = 40
    Content = {
      414442530F00EA4799030000FF00010001FF02FF0304002A000000460044004D
  ...
  object FDTableSorite: TFDTable
    Active = True
    IndexFieldNames = 'Annee;Num;typevente'
    Connection = FDConnection1
  ...
  object FDMemTableCredit: TFDMemTable
    ...
    Top = 104
    Content = {
      414442530F00EA47D0000000FF00010001FF02FF03040020000000460044004D
